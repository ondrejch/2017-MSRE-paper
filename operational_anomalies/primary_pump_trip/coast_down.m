...
figure(1);title('n/n_0');xlabel('Time (s)');ylabel('Fractional Power'); legend ('1.5','2','3','6','10');
figure(2);title('Core Outlet Temperature');xlabel('Time (s)');ylabel('Temperature (\circC)'); legend ('1.5','2','3','6','10');
figure(3);title('Core Average Temperature');xlabel('Time (s)');ylabel('Temperature (\circC)'); legend ('1.5','2','3','6','10');
figure(4);title('Graphite Temperature');xlabel('Time (s)');ylabel('Temperature (\circC)'); legend ('1.5','2','3','6','10');
figure(5);title('Heat Exchanger Outlet Temperature');xlabel('Time (s)');ylabel('Temperature (\circC)'); legend ('1.5','2','3','6','10');
figure(6);title('Heat Exchanger Inlet Temperature');xlabel('Time (s)');ylabel('Temperature (\circC)'); legend ('1.5','2','3','6','10');
figure(7);title('Fuel salt leaving HE');xlabel('Time (s)');ylabel('Temperature (\circC)'); legend ('1.5','2','3','6','10');
