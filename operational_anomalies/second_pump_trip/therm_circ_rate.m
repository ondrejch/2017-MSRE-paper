clear; close all; clc;
run('Parameters_MSRE_sec_pump_U233.m')
i=1;
...
figure;plot(new_tout{1}-1000,new_inlet{1},new_tout{2}-1000,new_inlet{2},new_tout{3}-1000,new_inlet{3},new_tout{4}-1000,new_inlet{4},new_tout{5}-1000,new_inlet{5}); grid on;
...
figure(7);title('Core Inlet Temperature');xlabel('Time (s)');ylabel('Temperature (\circC)');% legend ('1%','2%','3%','4%','5%');
