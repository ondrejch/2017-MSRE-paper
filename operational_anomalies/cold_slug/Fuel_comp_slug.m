clear; close all; clc;
a='Parameters_MSRE_cold_slug_U235.m';
b='Parameters_MSRE_cold_slug_U233.m';
i=1;
for parm_file = [1 2]
...
p = figure('color','w');
p(1) = subplot(1,2,1); plot(new_tout{1}-1000,new_power{1});
p(2) = subplot(1,2,2); plot(new_tout{2}-1000,new_power{2});